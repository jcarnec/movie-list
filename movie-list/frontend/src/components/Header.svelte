<script>
  ...
  import SelectedPeronCard from "./SelectedPersonCard.svelte";
...
<div class="h-screen overflow-y-auto custom-scrollbar">
  <div class="card w-80 bg-base-200 shadow-xl m-6">
    <div class="card-body">
      <h5 class="text-xl font-bold">Filter Options</h5>
        <!-- Reset Button -->
      ...
      <form class="space-y-4">
        ...
        <div>
          <SelectedPeronCard></SelectedPeronCard>
        </div>
        <div>
          <InputWithClear
            id="person-input"
        ...
        <div class="form-control">
          <InputWithClear
            ...
            defaultValue={$selectedTitle !== DEFAULT_TITLE
              ? "show_clear"
              : null}
